...
def pass_context(f):
	...
	def _func(ctx, *args, **kwargs):
		...
		try:
			ret = f(ham_t._dict(ctx.obj), *args, **kwargs)
		except ham_t.exceptions.SiteNotSpecifiedError as e:
			click.secho(str(e), fg="yellow")
			sys.exit(1)
		except ham_t.exceptions.IncorrectSitePath:
...
def get_site(context, raise_err=True):
	try:
		...
		if raise_err:
			raise ham_t.SiteNotSpecifiedError
		return None
...
def get_commands():
	...
	clickable_link = "\x1b]8;;https://ham_tframework.com/docs\aham_tframework.com\x1b]8;;\a"
	all_commands = (
